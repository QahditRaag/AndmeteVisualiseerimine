...
ui <- fluidPage(
  ...
  helpText("Maailma Terviseorganisatsiooni poolt kogutud andmete põhjal maailma õnnelikkuse raportite tulemuste visualiseerimine"),
    ...
    tabPanel("Rakenduse kirjeldus",
             sidebarLayout(
               ...
               mainPanel(
                 ...
                 p("Projekti koostamise aluseks on võetud Maailma Terviseorganisatsiooni poolt koostatud iga-aastane maailma õnnelikkuse raport (World Happiness Report). Andmed pärinevad veebikeskkonnas Kaggle ning on esitatud .csv formaadis. Andmed on leitavad:"),a("https://www.kaggle.com/datasets/mathurinache/world-happiness-report") ,
                 br(),
                 br(),
                 br(),
                 h4 ("Projekti eesmärgid:"),
                 p(" - anda ülevaade aastatel 2015-2022 Maailma Terviseorganisatsiooni poolt koostatud raportite andmestikust"),
                 p(" - analüüsida ning visualiseerida: "),
                 p("     1. Õnneindeksit seletavate tunnuste osakaalu eri riikides"),
                 p("     2. 20 kõige õnnetuma ja õnnelikuma riigi järjestust"),
                 p("     3. Õnneindeksi seoseid eri tunnuste vahel"),
                 ...
                 p("- õnneindeksi väärtust seletavate tunnuste osakaal riigiti"),
    ...
    tabPanel("Andmed",
             sidebarLayout(
               sidebarPanel(h3("Ülemaailmne õnnelikkus 2015-2022"),
                            ...
                            h3("Andmete ülevaade"),
                            p("Andmestikus on kokku 12 tulpa ja 1251 rida. Andmed on kogutud küsitluse teel ning vastajatel on palutud hinnata oma heaolu 10 palli skaalal, kus 10 on kõige parem tulemus. Õnneindeksi tulemust aitavad seletada kuus mõõdetavat tunnust ning kaugus düstoopia väärtusest."),
                            h3("Tunnused"),
                            p(strong("year"),": aasta"),
                            p(strong("country"),": riik"),
                            p(strong("region"),": regioon"),
                            p(strong("happiness_rank"),": koht õnnelikkuse pingereas"),
